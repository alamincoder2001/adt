...
<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
	<div class="row">
		...
		<div class="form-group" style="display: none;">
			<div class="col-md-4" style="display: flex;margin-left: -12px;">
				<label class="col-md-4 control-label no-padding-right"> Reference </label>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-md-6">
						<form v-on:submit.prevent="addToCart">
							...
							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right"> Serial Qty </label>
							...
							<div class="form-group">
								<label class="col-xs-4 control-label no-padding-right"> Warranty <small>(Month)</small> </label>
								<div class="col-xs-8">
			...
			<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
				<thead>
					<tr>
						...
						<th style="width:13%;color:#000;">Warranty</th>
								...
								<tr>
									<td>
										<div class="form-group">
											...
											<div class="col-xs-12">
												<input type="number" id="paid" class="form-control" v-model="purchase.paid" v-on:input="calculateTotal"  :readonly="selectedSupplier.Supplier_Type == 'G' ? true : false"/>
											</div>
										</div>
									</td>
								</tr>
				...
				if (this.selectedProduct.Product_SlNo == '') {
					...
					if (cartInd > -1) {
						...
						if (this.is_sequence) {
							...
							let _serialAlphabets = _serial.match(/^[a-zA-Z ]*/)
			...
			async removeFromCart(ind, prod_id, product) {
				if ((this.purchase.purchaseId != 0)) {
					...
					if (product.quantity > productStock) {
						alert('Unavailable stock. Product can not be removed');
						return;
					}
