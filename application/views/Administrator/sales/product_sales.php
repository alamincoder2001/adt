						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div v-if="item_type == 'product'" class="col-sm-9">
										<input type="text" v-model="selectedProduct.warranty" placeholder="6 Months" class="form-control" />
									</div>
									<div v-else class="col-sm-9">
										<input type="text" v-model="selectedIEMI.warranty" placeholder="6 Months" class="form-control" />
									</div>
								</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:15%;color:#000;">Warranty</th>
			...
			addToCart(){
				...
				if (this.item_type == 'product') {
					addNewObj = {
						...
						warranty: this.selectedProduct.warranty == undefined ? '-': this.selectedProduct.warranty,
						SerialStore: []
					}
				} else {
					addNewObj = {
						...
						warranty: this.selectedIEMI.warranty == undefined ? '-': this.selectedIEMI.warranty,
						SerialStore:[{
