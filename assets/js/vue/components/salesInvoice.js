        ...
        <div>
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <label for="without_due" style="margin-left: 10px;">
                        <input type="checkbox" v-model="without_due" id="without_due" value="1"> Print Without Due
                    </label>
                </div>
            </div>
            <div id="invoiceContent">
                    ...
                    <div class="col-xs-12">
                        <table _a584de>
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    <td colspan="3" style="text-right">Total :</td>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <br>
                        <table class="pull-left" v-if="!without_due">
                            <tr>
                    ...
                    <body>
                        ...
                        <div class="container">
                            ...
                            <div style="margin-top:30px">
                                ...
                                <p>
                                    Warranty will ignore if there any physical damage, <br>
                                    burn case or warranty sticker removed sold goods are not refundable.
                                </p>
                            </div>
                        </div>
